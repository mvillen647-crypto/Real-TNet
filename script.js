...
async function startScan() {
    ...
    try {
        ...
        const aiScore = ((data.type?.ai_generated || 0) * 100).toFixed(2);
        const humanScore = (100 - aiScore).toFixed(2);
        ...
        const safeScore = ((data.nudity?.none || 0) * 100).toFixed(2);

        const goreScore = ((data.gore?.prob || 0) * 100).toFixed(2);
...
<h2>${badge} Scan Complete</h2>

<p class="scan-verdict">${verdict}</p>
...
<div class="progress">
<div class="fill" style="width:${aiScore}%"></div>
</div>
...
<div class="progress">
<div class="fill" style="width:${humanScore}%"></div>
</div>
...
<div class="progress">
<div class="fill" style="width:${safeScore}%"></div>
</div>
...
<div class="progress">
<div class="fill" style="width:${goreScore}%"></div>
</div>
...
<p><b>Faces Detected:</b> ${faces}</p>

<p><b>Image Safety:</b> ${
safeScore > 95 ? "✅ Safe" : "⚠️ Sensitive"
}</p>

<p><b>AI Verdict:</b> ${badge} ${verdict}</p>
